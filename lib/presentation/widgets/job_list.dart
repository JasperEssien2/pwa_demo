...
import 'package:pwa_demo/presentation/widgets/user_profile_avatar.dart';
...
class JobCard extends StatelessWidget {
            ...
            builder: (context, _) {
              return Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color:
                        _isSelected(context) ? lightGreen : Colors.transparent,
                  ),
                ),
                child: Column(
  ...
  bool _isSelected(BuildContext context) {
    ...
    return context.isLargeScreen && params['id'] == model.id.toString();
  }
